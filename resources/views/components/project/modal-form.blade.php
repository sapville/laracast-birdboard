    ...
    <div class="fixed z-10 inset-0 overflow-y-auto">
        <div x-bind="dialog"
            ...
            <div
                ...
                <div class="bg-bgMain px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <div class="flex flex-row justify-between">
                        <div class="w-1/2">
                            ...
                            <input class="mb-2 border border-gray-400 p-2 w-full text-sm"
                        ...
                        <div class="w-1/2 ml-4">
                            ...
                            <p class="text-xs text-red-600">Something is wrong with a task</p>
                            <input
                                required
                                class="w-full p-2 text-sm border border-gray-400"
                ...
                <div class="bg-bgMain px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                    <x-button x-bind="trigger" type="button"
                              :button-style="'bg-white border-gray-400 text-gray-700 hover:text-white'">Cancel
                    </x-button>
                    <x-button class="mr-2">Submit</x-button>
                </div>
            </div>
        </div>
    </div>
